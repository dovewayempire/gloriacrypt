                ...
                <div class="container-xxl">
                        ...
                        <div class="col-lg-12 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                                <!-- Form -->
                                <form action="{{route('admin.post.login')}}" method="POST" class="row g-1 p-3 p-md-4">
                                     @csrf
                                        ...
                                        <div class="mb-2">
                                            <div class="form-label">
                                                <span class="d-flex justify-content-between align-items-center">
                                                    Password
                                                    <a class="text-secondary" href="{{route('GetResetPasswordForm')}}">Forgot Password?</a>
                                                </span>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 text-center mt-4">
                                            <button  class="btn btn-lg btn-block btn-primary lift text-uppercase" atl="signin">SIGN IN</button>
                                        </div>
                                    </div>
